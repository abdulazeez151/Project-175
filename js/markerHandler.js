...
AFRAME.registerComponent("markerhandler", {
  init: async function () {
    this.el.addEventListener("markerFound", () => {
      ...
      this.el.setAttribute("visisble", true);
    });
  ...
  placeTheModel: function (models, modelName) {
    ...
    if(isListContainModel) {
      ...
      if (distance < 1.25) {
        ...
        //Checking model is placed or not in the scene.
        ...
        if (isModelPlaced === null) {
            ...
            el.setAttribute("gltf-model", `url(${modelGeometry.model_name})`);
